...
void IRAM_ATTR I2S::interruptStatic(void *arg) {
  ...
  REG_WRITE(I2S_INT_CLR_REG(((I2S *) arg)->i2sIndex),
            (REG_READ(I2S_INT_RAW_REG(((I2S *) arg)->i2sIndex)) & 0xffffffc0) | 0x3f);
...
bool I2S::initParallelOutputMode(const int *pinMap, long sampleRate, const int bitCount, int wordSelect,
                                 int baseClock) {
  volatile i2s_dev_t &i2s = *i2sDevices[i2sIndex];
  // route peripherals
